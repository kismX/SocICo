...
class Profile(models.Model):
    ...
    # 2023-11-22 neu get_friends() um alle bestehenden freundchaften zu ermitteln
    ...
    def get_friends(self):
        ...
        return [friend for friend in friends] # spucke mir jeden friend in friends aus (wollt mal wiededr dings hier üben.. [ ])
    



# neues model dass eine Friednship darstellt
# es hat den from_user , von dem die anfrage ausgeht und to_user an den die anfrage geht
# wann wurde die verbindung erstellt geht automatisch mir createtd_at und wenn angenommen , wird das leere aceptet_at ausgefült
