"""
Django settings for socico project.
...
from decouple import config  # für umgebungsvariablen
...
MIDDLEWARE = [
    ...
    'basics.middleware.ProfileCompletionMiddleware', # die registration-profile-loop-middelware
]

ROOT_URLCONF = 'socico.urls'
